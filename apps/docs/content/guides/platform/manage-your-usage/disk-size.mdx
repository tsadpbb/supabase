...
Each Supabase project has a dedicated [disk](/docs/guides/platform/compute-and-disk#disk). You are charged for the provisioned disk size.
...
1 GB-Hrs is $0.000171 ($0.125 per GB per month).
Each project gets provisioned with an 8 GB disk for free. You are only charged for the disk size exceeding these 8 GB.

| Plan       | Included Disk Size | Over-Usage per GB | Over-Usage per GB-Hrs |
|------------|--------------------|-------------------|-----------------------|
...
| Plan       | Included Disk size | Usage per GB | Usage per GB-Hrs |
|------------|--------------------|--------------|------------------|
