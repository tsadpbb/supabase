...
title: 'Manage Point-in-Time Recovery (PITR) usage'
---

## What you are charged for
You can configure Point-in-Time Recovery (PITR) for a project by enabling the [PITR add-on](/docs/guides/platform/backups#point-in-time-recovery). You are charged for every enabled PITR add-on across your projects.
